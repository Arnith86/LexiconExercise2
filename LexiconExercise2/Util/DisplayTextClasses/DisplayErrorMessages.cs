...
namespace LexiconExercise2.Util.DisplayTextClasses
{
	...
	internal class DisplayErrorMessages
	{
		...
		/// <summary>
		/// Used to inform that input supplied cannot be empty.
		/// </summary>
		internal void InvalidInputNegativeValue() =>
			DisplayErrorMessage("Input cannot be a negative value! Please try again.");
